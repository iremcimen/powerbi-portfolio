# Power BI Finansal Yönetici Özeti Dashboard’u

- Bu repo, **Microsoft Power BI** kullanılarak geliştirilmiş **yönetici seviyesinde bir finansal dashboard** içermektedir.  
- Proje, finansal performans analizi ve etkili dashboard tasarım prensiplerine odaklanmaktadır.
---
...
- Bu projede kullanılan veri seti, **internet üzerinden temin edilmiş, herkese açık bir eğitim veri setidir**.
- **Özel, gizli veya kuruma ait herhangi bir veri içermemektedir**.
...
- DAX (ölçüler ve KPI’lar)
- Excel (.xlsx) tabanlı veri seti